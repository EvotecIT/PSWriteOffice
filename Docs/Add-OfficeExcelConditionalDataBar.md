...
### Document
```powershell
Add-OfficeExcelConditionalDataBar [[-Range] <string>] [-Color] <string> -Document <ExcelDocument> [-Sheet <string>] [-SheetIndex <Int32>] [-HeaderName <string>] [-TableName <string>] [-PivotTableName <string>] [-PivotWholeTable] [-HeaderRow <int>] [-IncludeHeader] [-PassThru] [<CommonParameters>]
```
