...
### __AllParameterSets
```powershell
Add-OfficePowerPointPlanCoverage [-Title] <string> -Locations <Object[]> [-Plan <PowerPointDeckPlan>] [-Subtitle <string>] [-Seed <string>] [-PassThru] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Add-OfficePowerPointPlanCoverage -Locations @('Value')
```
