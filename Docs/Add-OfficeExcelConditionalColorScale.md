...
### Document
```powershell
Add-OfficeExcelConditionalColorScale [[-Range] <string>] [-StartColor] <string> [-EndColor] <string> -Document <ExcelDocument> [-Sheet <string>] [-SheetIndex <int>] [-HeaderName <string>] [-TableName <string>] [-PivotTableName <string>] [-PivotWholeTable] [-HeaderRow <int>] [-IncludeHeader] [-PassThru] [<CommonParameters>]
```
