...
## DESCRIPTION
Downloads an image from a URL and anchors it to the requested worksheet cell. This is a discoverability-focused wrapper over the existing URL support in `Add-OfficeExcelImage`.
...
Downloads the remote image and anchors it to B2.
