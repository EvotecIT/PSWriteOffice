...
### Context (Default)
```powershell
Set-OfficeExcelGridlines [-Show] [-Hide] [-PassThru] [<CommonParameters>]
```

### Document
```powershell
Set-OfficeExcelGridlines -Document <ExcelDocument> [-Sheet <string>] [-SheetIndex <Int32>] [-Show] [-Hide] [-PassThru] [<CommonParameters>]
```
