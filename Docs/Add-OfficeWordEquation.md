...
### EXAMPLE 1
```powershell
PS> Add-OfficeWordEquation -Omml '<m:oMath xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math"><m:r><m:t>x+1</m:t></m:r></m:oMath>'
```

Inserts the OMML equation into the current document.
