...
### Path (Default)
```powershell
Get-OfficeWordComboBox [-InputPath] <string> [-Alias <string[]>] [-Tag <string[]>] [<CommonParameters>]
```

### Document
```powershell
Get-OfficeWordComboBox -Document <WordDocument> [-Alias <string[]>] [-Tag <string[]>] [<CommonParameters>]
```
