...
### __AllParameterSets
```powershell
Add-OfficePowerPointPlanSection [-Title] <string> [-Plan <PowerPointDeckPlan>] [-Subtitle <string>] [-Seed <string>] [-PassThru] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Add-OfficePowerPointPlanSection -PassThru
```
