...
### Path (Default)
```powershell
Get-OfficeWordRepeatingSection [-InputPath] <string> [-Alias <string[]>] [-Tag <string[]>] [<CommonParameters>]
```

### Document
```powershell
Get-OfficeWordRepeatingSection -Document <WordDocument> [-Alias <string[]>] [-Tag <string[]>] [<CommonParameters>]
```
