@{
    ...
    FunctionsToExport      = @('ConvertFrom-HTMLtoWord', 'New-OfficeExcelTable', 'New-OfficeExcelTableOptions', 'Set-OfficeExcelCellStyle', 'Set-OfficeExcelWorkSheetStyle')
