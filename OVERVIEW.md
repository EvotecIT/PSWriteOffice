...
- Excel from HTML tables: use PSParseHTML/HtmlTinkerX to produce `DataTable`/`DataSet`, then pipe into [Docs/Export-OfficeExcel.md](Docs/Export-OfficeExcel.md); see [Examples/Excel/Example-ExcelHtmlTablesViaPSParseHTML.ps1](Examples/Excel/Example-ExcelHtmlTablesViaPSParseHTML.ps1)
...
- [Examples/Excel/Example-ExcelHtmlTablesViaPSParseHTML.ps1](Examples/Excel/Example-ExcelHtmlTablesViaPSParseHTML.ps1)
